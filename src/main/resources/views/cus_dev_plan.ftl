        ...
        <table id="dg" class="easyui-datagrid"
            ...
            <thead>
                    <tr>
                        ...
                        <th field="state" width="100" align="center" hidden="true" hidden="true">状态</th>
                        <th field="devResult" width="200" align="center" hidden="true">客户开发状态</th>
                        <th field="operation" width="80" align="center"  formatter="formatterOptions">操作</th>
                    </tr>
            </thead>
        </table>
<div id="tb">
...
<div id="dlg" class="easyui-dialog" style="width:800px;height:500px" resizable="true" closed="true" >
    <#--营销机会详情展示-->
        ...
        <form id="fm">
            <table cellspacing="8px">
               ...
               <tr>
                    ...
                    <td>    </td>
                    <td>创建时间：</td>
                    <td><input type="text" id="createTime" name="createDate" readonly="readonly" /></td>
                </tr>
                <tr>
                    <td>指派给：</td>
                    <td>
    ...
    <#--开发计划详情记录-->
    <table id="dg02" class="easyui-datagrid" title="开发计划项"
           toolbar="#toolbar02"  pagination="true" rownumbers="true" fitColumns="true" singleSelect="true">
        <thead>
        <tr>
